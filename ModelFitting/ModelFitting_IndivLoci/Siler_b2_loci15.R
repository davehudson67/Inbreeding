...
pdf("IndivLociOutputs/Siler_b2L15.pdf")
...
## save MCMC
saveRDS(samples, "IndivLociOutputs/samples_s_b2L15.rds")
...
saveRDS(logimpweight, "IndivLociOutputs/logimpweight_s_b2L15.rds")
