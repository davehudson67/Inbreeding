...
pdf("outputs/SexInfectionInbreed_CONT_ICubs.pdf")
...
## save MCMC
saveRDS(samples, "outputs/SexInfectionInbreed_CONT_Samples_ICubs.rds")
...
saveRDS(res, "outputs/SexInfectionInbreed_CONT_PosteriorModelProbs_ICubs.rds")
