...
## save mcmc ouput
saveRDS(run, "outputs/Sex3InfectionInbrCATmed_AllParameters_runsamples.rds")
...
res
res
saveRDS(res, "outputs/Sex3InfectionInbrCATmed_AllParameters_PosteriorModelProbs.rds")
